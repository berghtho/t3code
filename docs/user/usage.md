...
If a window looks stale, refresh Limits to re-check providers and hubs on connected environments.
On web and desktop, the environment filter also applies to Limits and refresh. Failed refreshes
name the affected environment; other environments still refresh.
