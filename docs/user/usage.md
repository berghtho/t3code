...
provider health-check interval and update live while a turn runs. **Refresh limits** checks every
connected environment; a failed refresh names the affected environment. API-key accounts have no
